<?php
   ...
   if (isset($_POST['logout'])) {
    ...
    if(isset($_POST['update_product'])) {
        ...
        $update_image = $_FILES['update_image']['update_name'];  
        $update_image_size = $_FILES['update_image']['update_size'];
        $update_image_tmp_name = $_FILES['update_image']['update_tmp_name'];  
...
<body>
    ...
    <section class="add-products form-container">
        <form method="post" action="" enctype="multipart/form-data">
            ...
            <input type="submit" name="add_product" value="add product" class="btns">
    ...
    <section class="update-container">
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <input type="reset" name ="" value="cancel" class="cancel-btn" class="option-btn btn"  id="close-form">
